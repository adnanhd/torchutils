...
class Trainer:
    __slots__ = ['xtype', 'ytype', '_model', '_handler', '_arguments']
    def __init__(
        self,
        model: TrainerModel,
    ...
    def create_dataloader(
        ...
        **kwargs,
        ...
        if isinstance(dataset, Dataset):
            ...
            return dataloader = torch.utils.data.DataLoader(dataset, **kwargs)
    ...
    def train(
        ...
        **kwargs
        ...
        self._handler = TrainerHandler(train_dl=train_dl, 
                valid_dl=valid_dl, args=args, model=model)
